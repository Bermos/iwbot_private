...
public class Constants {
    ...
    public final static String BGS_FACTION_HELP = "**Help: Manage BGS Factions**\n" + Listener.prefix + "bgs faction, <command modifier {add, edit, hide, show, list, assign, remove}>";
    ...
    public final static String BGS_FACTION_REMOVE_HELP = "**Help: Remove BGS Faction from a System**\n" + Listener.prefix + "bgs faction, remove, <factionname>, <systemname>";
